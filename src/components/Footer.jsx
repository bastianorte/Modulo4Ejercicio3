  ...
  return (
    <footer className="text-center bg-primary lg:text-left bottom-0">
      <div className="flex w-full max-w-48 flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between mx-auto">
          <a href="#" className="text-lg font-medium text-white hover:underline"><FaInstagram /></a>
          <a href="#" className="text-lg font-medium text-white hover:underline"><FaXTwitter /></a>
          <a href="#" className="text-lg font-medium text-white hover:underline"><FaFacebookF /></a>
      </div>
